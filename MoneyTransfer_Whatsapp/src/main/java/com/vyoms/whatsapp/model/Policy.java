...
public class Policy {
   ...
   public int contactNumber = 0;
	...
	public int balnancenumberindexrow=0;
	...
	public int getBalnancenumberindexrow() {
		return balnancenumberindexrow;
	}

	public void setBalnancenumberindexrow(int balnancenumberindexrow) {
		this.balnancenumberindexrow = balnancenumberindexrow;
	}
